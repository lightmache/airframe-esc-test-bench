...
/* [Global] */
partToGenerate = "FuselageNose"; //[ShellOnly,FuselageRear,FuselageNose,FuselageHatch,RootWing,TipWing,Fin,Elevon,ServoGuard]
...
bodyFrac140 = 0.27;
bodyFrac90 = 0.37;
HatchLen = bodyLen*(noseLen*(bodyFrac140-bodyFrac90)/(140-90)+bodyFrac90-90*(bodyFrac140-bodyFrac90)/(140-90))+18;

trayFloorY = -0.17*bodyH;
//HatchHeight = 0.33*bodyH;

hatchAngle = -4.5;
//HatchHeight = trayFloorY+trayNoseHeight-HatchFrontX*sin(hatchAngle)+3;
HatchHeight = trayFloorY+0.55*bodyH-HatchFrontX*sin(hatchAngle)+3;
...
offsetH = lambda*offset90 + (1-lambda)*offset140+0.6;
         ...
         union()
            ...
            hull()
               ...
               translate([0.85*trayMaxLen,trayFloorY,0])
                  cube([0.1,0.55*trayHeight-1,0.8*trayWidth/2]);
